...
that one list drives the caption burn-in and timings, so they cannot drift apart.
Capture guidance lives in `docs/AUTOMATION.md`.
...
Outputs, all under `docs/media/`: `showcase.mp4` and `showcase-preview.gif`. The PNG
...
def main() -> None:
    ...
    parser.add_argument("--out", default=None, help="where the MP4/GIF go (default docs/media)")
