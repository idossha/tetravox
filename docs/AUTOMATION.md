...
Scene paths must be absolute and canonical (resolve symlinks in parent directories first); symlink
targets are rejected for both loading and saving. Ordinary scene-loading guards still apply.
