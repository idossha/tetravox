...
| Quantity | Value |
|---|---|
| Parse + boundary + upload + first frame | 602 ms |
...
| Frame interval, median · p95 | 8.3 ms · 9.8 ms |
...
| Cap triangles at the last plane | 61,351 |
...
| Frame interval, median · p95 | 264.8 ms · 480.5 ms |
| Budget | 33.3 ms (30 fps) — not gated on this leg |
| New cross-section on screen, median · p95 | 265 ms · 481 ms |
| New cross-sections per second | 3.4 Hz (7 in the drag) |
| Cap triangles at the last plane | 52,646 |
