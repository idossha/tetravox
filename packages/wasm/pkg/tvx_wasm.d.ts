 ...
 */
export function mesh_contours(handle: number, plane: Float32Array, mask_id?: number | null, annotation?: string | null, field?: string | null, component?: string | null): any;
...
export interface InitOutput {
    ...
    readonly mesh_contours: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number];
