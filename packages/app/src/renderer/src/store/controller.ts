...
import type {
  ...
  VolumeLayer,
  vec3,
  // A-PROPS, appended: the clip-plane 'follow cursor' affordance patches a `MeshLayer` from a
  // `cursor` event. (`Layer` is already imported above — the property editors patch any kind.)
  MeshLayer,
